...
export default class Hash {
    ...
    public static make(data: string, round: number = 10): Promise<string> {
    ...
    private static makeCustomHashString(lowerCase: boolean = true, upperCase: boolean = true, decimal: boolean = true): string {
